...
paths:
  ...
  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.insights/webtests:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightswebtests-get
      parameters:
      - in: query
        name: No Name
      responses:
  ...
  /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.insights/webtests/{webTestName}:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightswebtestswebtestname-get
      parameters:
      - in: query
        name: No Name
      responses:
    ...
    put:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightswebtestswebtestname-put
      parameters:
      - in: query
        name: No Name
      - in: body
    ...
    patch:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightswebtestswebtestname-patch
      parameters:
      - in: query
        name: No Name
      - in: body
    ...
    delete:
      ...
      x-api-path-slug: subscriptionssubscriptionidresourcegroupsresourcegroupnameprovidersmicrosoftinsightswebtestswebtestname-delete
      parameters:
      - in: query
        name: No Name
      responses:
  ...
  /subscriptions/{subscriptionId}/providers/microsoft.insights/webtests:
    get:
      ...
      x-api-path-slug: subscriptionssubscriptionidprovidersmicrosoftinsightswebtests-get
      parameters:
      - in: query
        name: No Name
      responses:
